...
const Slide = (props) => {
    ...
    useEffect(() => {
        axios.get('http://localhost/scrapping/', { headers: { 'Content-Type': 'application/json' } })
            .then(res => {
                setCarList(res.data);
            })
            .catch((e) => {
        ...
        axios.get('http://localhost/scrapping/buttonlist.php', { headers: { 'Content-Type': 'application/json' } })
            .then(res1 => {
